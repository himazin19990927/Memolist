//
//  ScheduleColorSelectorViewController.swift
//  Memolist
//
...
class ScheduleColorSelectorViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        ScheduleController.instance.scheduleBuf?.color = colorCell.color
