...
class MemoWidgetEditor: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(tableView: UITableView, commitEditingStyle editingStyle: UITableViewCellEditingStyle, forRowAtIndexPath indexPath: NSIndexPath) {
        ...
        //削除リストに入れておく
        ItemController.instance.deleteList.append(scheduleItem!.widgets[indexPath.row])
